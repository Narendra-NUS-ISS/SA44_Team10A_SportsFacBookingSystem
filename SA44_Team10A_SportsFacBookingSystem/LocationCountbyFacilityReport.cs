...
{
    public partial class LocationCountbyFacilityReport : Form
    {
        public LocationCountbyFacilityReport()
        {
            InitializeComponent();
        }
        ...
        private void crystalReportViewer1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                fa.Fill(ds.Facility);
                CRLocationCountByFacilityReport report = new CRLocationCountByFacilityReport();
